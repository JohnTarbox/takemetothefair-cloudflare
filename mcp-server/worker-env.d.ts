/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false --env-interface=WorkerEnv worker-env.d.ts` (hash: 898c061fb41fb7e35d540f7c06d42871)
...
interface __BaseEnv_WorkerEnv {
  ...
  MCP_OBJECT: DurableObjectNamespace<import("./src/index").MeetMeAtTheFairMCP>;
  BURST_COUNTER: DurableObjectNamespace<import("./src/index").BurstCounter>;
  MAIN_APP: Fetcher /* meetmeatthefair-app */;
  SCHEMA_ORG_SYNC: Workflow<
    Parameters<import("./src/index").SchemaOrgSyncWorkflow["run"]>[0]["payload"]
  >;
  RECOMMENDATIONS_SCAN: Workflow<
    Parameters<import("./src/index").RecommendationsScanWorkflow["run"]>[0]["payload"]
  >;
  EVENT_DATE_DRIFT: Workflow<
    Parameters<import("./src/index").EventDateDriftWorkflow["run"]>[0]["payload"]
  >;
...
declare namespace Cloudflare {
  interface GlobalProps {
    ...
    durableNamespaces: "MeetMeAtTheFairMCP" | "BurstCounter";
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      ...
      | "SPAM_EVENT_RECOVERY_ENABLED"
      | "PHOTO_VISION_ENABLED"
      | "PHOTO_AUTOWRITE_ENABLED"
      | "SUBMIT_ADMIN_FORWARD"
    >
  > {}
}

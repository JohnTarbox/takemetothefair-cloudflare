      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 pt-8 border-t border-white/20 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            {/* External social links — use plain <a> rather than IconLink/<Link>
                because next/link is for internal routing and warns on external
                hrefs. These are already aria-labeled + hit-area-padded (p-3 →
                48px); the no-restricted-syntax rule below is for catching NEW
                unlabeled svg-in-anchor patterns, not for retroactively breaking
                already-accessible external links. */}
            <a
              href="https://facebook.com/meetmeatthefair"
              target="_blank"
              rel="noopener noreferrer"
              className="text-secondary-foreground transition-colors p-3"

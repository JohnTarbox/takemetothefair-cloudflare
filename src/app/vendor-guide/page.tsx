...
The claim flow requires email-control proof of the email an account
was registered with, but it doesn't verify that the email belongs to
the business owner. We can investigate disputed claims case-by-case.

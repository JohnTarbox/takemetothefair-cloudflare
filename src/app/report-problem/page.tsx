      ...
      <form action="/api/report-problem" method="POST" className="mt-8 space-y-5">
        ...
        <div>
          ...
          <input
            ...
            className="mt-1 w-full px-3 py-2 border border-gray-300 rounded-lg focus:border-royal focus:outline-none focus:ring-1 focus:ring-royal"
          />
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
          <button
            type="submit"
            className="px-5 py-2.5 rounded-lg bg-royal text-white font-semibold hover:bg-royal/90 focus:outline-none focus:ring-2 focus:ring-royal focus:ring-offset-1 transition-colors"
          >
            Send report
          </button>
          <Link
            href="/"
            className="px-5 py-2.5 rounded-lg border border-gray-300 text-gray-700 font-medium text-center hover:bg-gray-50"
          >
            Cancel
          </Link>
        </div>

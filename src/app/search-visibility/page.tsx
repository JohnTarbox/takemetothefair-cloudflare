...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Search Visibility | Meet Me at the Fair",
    description:
      "Learn how Meet Me at the Fair helps your events, venues, and vendor profiles appear in Google search results.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Meet Me at the Fair — Search Visibility",
      },
    ],
  },
  twitter: {
    ...
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      <BreadcrumbSchema
        items={[
          ...
          { name: "Search Visibility", url: "https://meetmeatthefair.com/search-visibility" },
        ]}
      />
      <WebPageSchema
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-brand-blue-light rounded-lg flex items-center justify-center">
                  <Calendar className="w-5 h-5 text-royal" aria-hidden="true" />
                </div>

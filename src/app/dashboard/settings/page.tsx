        ...
        <CardContent>
          ...
          {revealedToken && (
            <div className="p-4 rounded-lg bg-amber-50 border border-amber-200 mb-4">
              ...
              <div className="flex items-center gap-2">
                <code className="flex-1 bg-card px-3 py-2 rounded border text-xs font-mono break-all">
                  {revealedToken}
                </code>
                ...
                <div key={token.id} className="py-3 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Created {token.createdAt ? formatDateMedium(token.createdAt) : "unknown"}
                      {token.lastUsedAt && <> · Last used {formatDateMedium(token.lastUsedAt)}</>}
                    </p>
                  </div>
                  <Button
                    type="button"

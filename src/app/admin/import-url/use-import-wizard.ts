    ...
    case "LOAD_EVENT_FOR_REVIEW":
      return {
        ...
        extractedData: {
          ...
          specificDates: action.event.specificDates,
          ...
          isStatewide: action.event.isStatewide,
          stateCode: action.event.stateCode,
    ...
    case "PROCEED_TO_REVIEW":
      return {
        ...
        extractedData: {
          ...
          specificDates: action.firstEvent.specificDates,
          ...
          isStatewide: action.firstEvent.isStatewide,
          stateCode: action.firstEvent.stateCode,
          ...
          categories: action.firstEvent.categories,

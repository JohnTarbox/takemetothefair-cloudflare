  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <p className="text-muted-foreground mb-6">
          Welcome to Meet Me at the Fair. By accessing or using our website, you agree to be bound
        ...
        <p className="text-muted-foreground mb-6">
          By accessing and using Meet Me at the Fair, you accept and agree to be bound by these
        ...
        <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">4. Event Listings</h2>
        <p className="text-muted-foreground mb-4">
        ...
        <p className="text-muted-foreground mb-6">
          We reserve the right to remove any listing that violates these terms or that we determine,
          in our sole discretion, is inappropriate.
        </p>

        <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">5. Vendor Profiles</h2>
        <p className="text-muted-foreground mb-6">
          Vendors who create profiles agree to provide accurate business information and to conduct
          themselves professionally when interacting with event promoters and attendees. We are not
          responsible for disputes between vendors and promoters.
        </p>

        <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">6. Intellectual Property</h2>
        <p className="text-muted-foreground mb-6">
          The content, features, and functionality of our website are owned by Meet Me at the Fair
        ...
        <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">7. User Content</h2>
        <p className="text-muted-foreground mb-6">
          By submitting content to our website (including event listings, vendor profiles, and
          images), you grant us a non-exclusive, royalty-free license to use, display, and
        ...
        <p className="text-muted-foreground mb-6">
          ...
          guarantee the accuracy of event listings or vendor information. We are not responsible for
          the quality, safety, or legality of events listed on our platform.
        </p>

        <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">9. Limitation of Liability</h2>
        <p className="text-muted-foreground mb-6">
          To the maximum extent permitted by law, Meet Me at the Fair shall not be liable for any
        ...
        <p className="text-muted-foreground mb-6">
          You agree to indemnify and hold harmless Meet Me at the Fair from any claims, damages, or
        ...
        <p className="text-muted-foreground mb-6">
          ...
          of these Terms. Upon termination, your right to use our services will immediately cease.
        </p>

        <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">12. Changes to Terms</h2>
        <p className="text-muted-foreground mb-6">
          We reserve the right to modify these Terms at any time. We will notify users of
          significant changes by posting a notice on our website. Continued use of our services
          after changes constitutes acceptance of the new Terms.
        </p>

        <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">13. Governing Law</h2>
        <p className="text-muted-foreground mb-6">

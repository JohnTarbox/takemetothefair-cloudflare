  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">2. Use of Services</h2>
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">4. Event Listings</h2>
        <p className="text-gray-600 mb-4">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">5. Vendor Profiles</h2>
        <p className="text-gray-600 mb-6">
